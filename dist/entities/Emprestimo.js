...
export class Emprestimo extends BaseEntity {
    ...
    status;
    dataDevolvido;
    constructor(id, livroId, membroId, dataEmprestimo, // ISO
    dataDevolucaoPrevista, // ISO
    status = 'ATIVO', dataDevolvido) {
        super(id);
    ...
    static fromJSON(o) { return new Emprestimo(o.id, o.livroId, o.membroId, o.dataEmprestimo, o.dataDevolucaoPrevista, o.status, o.dataDevolvido); }
}
